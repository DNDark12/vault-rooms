 ...
 *  field's own description asks for "this device's LAN address", so a bare "192.168.1.42" or
 *  "192.168.1.42:9000" - not just "http://192.168.1.42" - is exactly what most users will type).
 *  `new URL(...)` throws on a schemeless input like "192.168.1.42:9000" instead of parsing it as
